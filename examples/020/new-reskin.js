...
const confirmColorInput = (color, colorType = "primary AKA block") => {
...
gamePrimaryColor = confirmColorInput(gamePrimaryColor, "primary AKA block");
gameSecondaryColor = confirmColorInput(
	gameSecondaryColor,
	"secondary AKA background"
);
